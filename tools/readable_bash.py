...
<html>
    ...
    <div class="container">
      <div class="row intro">
        ...
        <p>This document is generated automatically from <a href="https://wspecsbox.email">wspecsbox</a>&rsquo;s setup script <a href="https://github.com/mail-in-a-box/wspecsbox">source code</a>.</p>
        <hr>
      </div>
    </div>
...
class BashScript(Grammar):
	...
	def parse(fn):
		...
		v = "<div class='row'><div class='col-xs-12 sourcefile'>view the bash source for the following section at <a href=\"%s\">%s</a></div></div>\n" \
			 % ("https://github.com/mail-in-a-box/wspecsbox/tree/master/" + fn, fn)
		...
		v = v.replace("`pwd`",  "<code><b>/path/to/wspecsbox</b></code>")
