#!/usr/bin/python3
#
# This is a tool Josh uses on his box serving wspecsbox.email to parse the nginx
# access log to see how many people are installing wspecsbox each day, by
...
outfn = "/home/user-data/www/wspecsbox.email/install-stats.json"
